<%-- 
    Document   : search_student_server
    Created on : 21-Feb-2024, 2:30:52 pm
    Author     : Acer
--%>
...
<%
    ...
    if (session.getAttribute("email") != null) {
        ...
        if (request.getParameter("search") != null) {
            ...
            if (check_already_exist()) {
                if (search_student(out)) {
                    session.setAttribute("student_search", "true");
                    ...
                    error_and_msg_search_student = "Server Issue";
                }

            } else {
                error_and_msg_search_student = "Student  Not Exist";
            }
    ...
    out.print(error_and_msg_search_student);

    session.setAttribute("error_and_msg_search_student", error_and_msg_search_student);
...
<%!
    ...
    public boolean search_student(JspWriter out) {
        valid = false;
        try {
